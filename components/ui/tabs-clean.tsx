...
const TabsClean = TabsPrimitive.Root

const TabsCleanList = React.forwardRef<
...
TabsCleanList.displayName = TabsPrimitive.List.displayName;

const TabsCleanTrigger = React.forwardRef<
...
TabsCleanTrigger.displayName = TabsPrimitive.Trigger.displayName;

const TabsCleanContent = React.forwardRef<
...
TabsCleanContent.displayName = TabsPrimitive.Content.displayName

export { TabsClean, TabsCleanList, TabsCleanTrigger, TabsCleanContent }
