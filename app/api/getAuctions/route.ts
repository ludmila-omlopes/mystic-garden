...
export async function GET() {
  try {
    const auctions = await getAuctions(); // Using ApolloClient-based getAuctions
    const auctionsData = auctions.publications.items; // No need to parse JSON as getAuctions returns data directly
